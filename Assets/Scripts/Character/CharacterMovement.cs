...
namespace ProjectHeart.Character
{
    ...
    public partial class CharacterMovement : MonoBehaviour
    {
        ...
        [System.Serializable]
        public class StateMachine : FiniteStateMachine<MovementState>
        {
            CharacterMovement _controller;
            public CharacterMovement Controller => _controller;

            public StateMachine(CharacterMovement controller)

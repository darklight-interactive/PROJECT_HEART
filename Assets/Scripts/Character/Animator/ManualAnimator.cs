...
{
    public abstract class ManualAnimator : MonoBehaviour
    {
        ...
        public void Initialize(Animator animator = null)
        {
            ...
            animationNames = AnimatorValues.GetAnimationNames();
            ...
            for (int i = 0; i < this.animator.layerCount; ++i)
            {
                ...
                for (int k = 0; k < AnimatorValues.Animations.Length; ++k)
                {
                    ...
                    {
                        currentAnimation[i] = (Animations)
                            Enum.GetValues(typeof(Animations)).GetValue(k);
        ...
        public bool Play(AnimationData data, int layer = 0)
        {
            try
            {
                ...
                animator.CrossFade(
                    AnimatorValues.GetHash(currentAnimation[layer]),
                    data.crossfade,
                    layer
                );
    ...
    public class AnimationData
    {
        ...
        public AnimationData(
            Animations animation = Animations.RESET,
    ...
    public class AnimatorValues
    {
        ...
        {
            return Enum.GetNames(typeof(Animations)).ToList();
        }
    }
